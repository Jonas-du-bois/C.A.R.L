...
## 2026-05-04 - DoS via Massive Payloads
**Vulnerability:** The application was vulnerable to Denial of Service (DoS) attacks via memory exhaustion from massive payloads because the `GatekeeperHandler` processed incoming messages without restricting their length.
...
**Prevention:** Implemented a maximum message body length check of 4096 characters at the beginning of `GatekeeperHandler.shouldProcess`.
