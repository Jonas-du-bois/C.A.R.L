...
## 2025-05-29 - Payload Size Limit Enforcement
**Vulnerability:** DoS risk via massive message payloads processed deep in the application stack.
**Learning:** Payload size enforcement must occur at the application edge before any stateful logic or expensive operations to prevent memory exhaustion.
**Prevention:** Added a strict 4096 character limit check at the start of GatekeeperHandler.shouldProcess().
