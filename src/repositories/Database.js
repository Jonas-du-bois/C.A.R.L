...
export class SQLiteDatabase {
  ...
  init() {
    ...
    this.#db.exec(`
      ...
      -- ⚡ Bolt: Composite index to optimize report generation (filtering by direction + sorting by time)
      CREATE INDEX IF NOT EXISTS idx_messages_direction_received ON messages(direction, received_at);
