...
export class SQLiteDatabase {
  ...
  init() {
    ...
    this.#db.exec(`
      ...
      -- ⚡ Bolt: Expression index to optimize sorting contacts by total message volume
      CREATE INDEX IF NOT EXISTS idx_contacts_total_messages ON contacts((total_messages_received + total_messages_sent) DESC);
