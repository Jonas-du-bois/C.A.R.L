...
export class MessageRepository {
  ...
  getTopContacts(limit = 10) {
    // ⚡ Bolt: Use pre-calculated stats from contacts table instead of expensive nested subqueries
    // This avoids N+1 query overhead and takes advantage of atomic increments already in place.
    return this.#db.prepare(`
      SELECT c.*, 
