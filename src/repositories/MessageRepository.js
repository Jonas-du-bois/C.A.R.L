...
export class MessageRepository {
  ...
  getTopContacts(limit = 10) {
    // ⚡ Bolt: Removed expensive correlated subqueries for messages count
    // Using the pre-calculated total_messages_received/sent columns that are atomically maintained
    return this.#db.prepare(`
      SELECT c.*, 
