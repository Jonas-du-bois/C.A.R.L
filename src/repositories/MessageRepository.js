...
export class MessageRepository {
  ...
  getTopContacts(limit = 10) {
    // ⚡ Bolt: Removed inefficient per-contact subqueries for messages_received and messages_sent
    // The contacts table already accurately tracks total_messages_received and total_messages_sent.
    return this.#db.prepare(`
      SELECT c.*, 
