...
export class MessageRepository {
   ...
   * @param {number|null} limitContacts - Limiter le nombre de contacts par activité (optionnel)
  ...
  getConversationsForReport(maxMessagesPerContact = 20, limitContacts = null) {
    ...
    if (limitContacts) {
      // ⚡ Bolt: Two-step query optimization for brief reports.
      // First, find the top N most active contact IDs today.
      ...
      // Only fetch full details for those specific contacts
